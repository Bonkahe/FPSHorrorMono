...
public partial class EnemyAIController : Node3D
{
    ...
    [Export] public Array<AudioStream> DamageSounds { get; set; } = new Array<AudioStream>();
    [Export] public Array<AudioStream> DeathSounds { get; set; } = new Array<AudioStream>();
    ...
    public void OnDamaged(Vector3 hitLocation, Vector3 force, Node3D AggressorBodyNode)
    {
        ...
        if (CurrentHealth <= 0)
        {
            ...
            {
                GetTree().CallGroup("AudioQues", "PlayAudioQue3D", DeathSounds[new RandomNumberGenerator().RandiRange(0, DeathSounds.Count - 1)], BaseSkeleton.GlobalPosition, 0);
            }
        ...
        else
        {
            ...
            {
                GetTree().CallGroup("AudioQues", "PlayAudioQue3D", DamageSounds[new RandomNumberGenerator().RandiRange(0, DamageSounds.Count - 1)], BaseSkeleton.GlobalPosition, 0);
            }
        }
    }
