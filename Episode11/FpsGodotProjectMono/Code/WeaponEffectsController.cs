...
public partial class WeaponEffectsController : Node
{
    ...
    private float currentTiltWeight;
    private Vector3 lastTiltOffsetVector;
    private Vector3 lastTiltLookAtVector;
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        if (IsAiming)
        {
            ...
            AimingIKContainer.GlobalTransform = AdjustToEnvironment(AimingIKContainer.GlobalTransform, (float)delta);
        }
        else
        {
            ...
            RightHandIdleIKContainer.GlobalTransform = AdjustToEnvironment(RightHandIdleIKContainer.GlobalTransform, (float)delta);
        }
    }

    public Transform3D AdjustToEnvironment(Transform3D targetGlobalTransform, float deltaTime)
    {
