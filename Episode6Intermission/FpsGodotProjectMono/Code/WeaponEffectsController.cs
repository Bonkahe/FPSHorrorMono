...
public partial class WeaponEffectsController : Node
{
    ...
    public void FireRevolver()
    {
        ...
        if (BarrelRayCast.IsColliding())
        {
            ...
            else if (ImpactedTarget is PhysicalBone3D physicsBody)
            {
                physicsBody.ApplyImpulse(-BarrelRayCast.GlobalTransform.Basis.Z * ImpactForce, hitLocation - physicsBody.GlobalPosition);
            }
