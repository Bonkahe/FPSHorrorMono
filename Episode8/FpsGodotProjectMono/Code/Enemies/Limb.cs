...
public partial class Limb : Node
{
    ...
    public void SetIKTargets()
    {
        ...
        LimbIKContainer.LookAt(newLookatPos,
            Mathf.Abs((Controller.ChestTargetContainer.GlobalTransform.Basis * (newLookatPos - LimbIKContainer.GlobalPosition)).Y) > 0.99f ? Controller.ChestTargetContainer.GlobalTransform.Basis.Z : Controller.ChestTargetContainer.GlobalTransform.Basis.Y);
    }
