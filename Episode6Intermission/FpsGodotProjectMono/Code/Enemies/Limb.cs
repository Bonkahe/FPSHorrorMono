...
{
    //[Export] public PhysicalBone3D LimbTipBone { get; set; }
    //[Export] public Node3D LimbIKTarget { get; set; }
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        if (CurrentlyTraveling)
        {
            ...
            //LimbIKTarget.GlobalPosition = CurrentTargetLocation;
            //LimbIKTarget.LookAt(CurrentCurve.OriginLocationControl.Lerp(CurrentCurve.TargetLocationControl, CurrentLerpValue));
